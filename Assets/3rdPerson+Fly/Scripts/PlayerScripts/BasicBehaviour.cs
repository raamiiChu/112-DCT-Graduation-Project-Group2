...
{
	private static BasicBehaviour instance;
	public float inputRatio = 1f;
	...
	public static BasicBehaviour GetInstance()
	{
		return instance;
	}
	...
	void Update()
	{
		...
		h = Input.GetAxis("Horizontal") * inputRatio;
		v = Input.GetAxis("Vertical") * inputRatio;
